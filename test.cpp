...
//    const double finalRotationCenterZ = finalParameters[4];
//    const double finalTranslationX    = finalParameters[5];
//    const double finalTranslationY    = finalParameters[6];
//    const double finalTranslationZ    = finalParameters[7];
